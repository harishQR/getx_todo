                        ...
                        trailing: IconButton(
                          onPressed: () {
                            showDialog(context: context, builder: (BuildContext){
                              return AlertDialog(
                                title: Text("Are you sure,about delete this content !"),
                                content: Row(
                                  ...
                                  children: [
                                    ElevatedButton(onPressed: (){
                                      ...
                                      Navigator.pop(context);
                                    }, child: Text('yes',style: TextStyle(color: Colors.red,fontSize: 24),)),
                                    ElevatedButton(onPressed: (){
                                       Navigator.pop(context);
                                    }, child: Text('No',style: TextStyle(color: Colors.grey,fontSize: 24),))
                                  ],
                                ),
                              );
                            });
